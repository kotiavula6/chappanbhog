...
extension KeychainItem {
    static var bundleIdentifier: String {
        return Bundle.main.bundleIdentifier ?? "com.enact.KnockKnock"
    }
    ...
    static func setFullUserName(value: String, accountText: String) {
        
        //        guard let value = newValues else {
        //            try? KeychainItem(service: KeychainItem.bundleIdentifier, account: accountText).deleteItem()
        //            return
        //        }
        do {
            try KeychainItem(service: KeychainItem.bundleIdentifier, account: accountText).saveItem(value)
        } catch {
            print("Unable to save userFirstName to keychain.")
        }
    ...
    static func getFullUserName(accountText: String) -> String? {
        return try? KeychainItem(service: KeychainItem.bundleIdentifier, account: accountText).readItem()
    }
